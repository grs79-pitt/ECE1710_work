...
%Seems like I did not have to do any modification to this script to get the
%right answer


%Defining the concentric neutral conductor data for the first line
cn.GMRc = 0.0171; %250,000 CM aluminum
cn.rc = 0.41; %250,000 CM aluminum
cn.diameter = 0.567; %250,000 CM aluminum
