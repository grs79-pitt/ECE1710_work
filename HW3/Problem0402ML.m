...
phase.GMR = 0.00446; %Modified for 1/0 ASCR
phase.resistance = 1.12; %Modified for 1/0 ASCR
phase.ncond = 3; %Three phase

%Defining the neutral conductor data
neutral.GMR = 0.00446; %Modified for 1/0 ASCR
neutral.resistance = 1.12; %Modified for 1/0 ASCR
...
d1 = 0+j*29; d2 = 7+j*29; d3 = 2.5+j*29; d4 = 4+j*25; %Changed for Problem 4.2
